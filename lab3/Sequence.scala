...
object Sequence extends App{
  ...
  println("a) " + testLastElement(Seq(User("Ch", 19), User("TblP", 12), User("MTUCI", 21), User("Scala", 5))))
  ...
  println("b) " + testZip(Seq( User("Ch", 21), User("TblP", 99)), Seq(User("MTUCI", 19), User("Scala", 12))))
