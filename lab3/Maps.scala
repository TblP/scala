...
object Maps extends App {
  ...
  println("a) " + testGroupUsers(Seq(User("Ch", 19), User("TblP", 12), User("MTUCI", 21), User("Scala", 5))))
  ...
  println("b) " + testNumberFrodos(Map(("HR", User("Ch", 32)),
    ("QA", User("UserAdam", 14)), ("Back", User("Adam", 92)), ("Front", User("Ch", 84)), ("DD", User("Ch", 19)),
    ("DevOps", User("Adam", 42)))))
  ...
  println("c) " + testUnderaged(Map(("HR", User("Ch", 32)),
    ("QA", User("UserAdam", 14)), ("Back", User("Adam", 92)), ("Front", User("Ch", 84)), ("DD", User("Ch", 19)),
    ("DevOps", User("Adam", 42)))))
}
