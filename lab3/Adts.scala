...
object Adts extends App {
  ...
  println("a) "+ testGetNth(List(0,1,2,3),2))
  println("a) "+ testGetNth(List(),1))
  println("a) "+ testGetNth(List(1,2),4))
  ...
  def testIsEven(n: Int): Either[String, Int] = Either.cond(n % 2 == 0, n, "Нечетное число.")
