...
object Compositions extends App{
  ...
  println("Compose: " +
    testCompose((n:Int) => List.tabulate(n)(_ + 1))(n => n.map((i: Int) => "test " + i.toString))(n => n.head + " - "
      + n.takeRight(1).head)((7)))
